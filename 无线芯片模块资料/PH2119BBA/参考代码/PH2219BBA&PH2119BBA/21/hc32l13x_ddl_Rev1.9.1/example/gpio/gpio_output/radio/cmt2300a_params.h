...
; Tx Power                  = +20 dBm    
; Gaussian BT               = NA         
; Bandwidth                 = Auto-Select
; CDR Type                  = Counting   
; CDR DR Range              = NA         
; AFC                       = On         
; AFC Method                = Auto-Select
; Data Representation       = 0:F-low 1:F
; Tx Duty-Cycle             = Off        
; Sleep Timer               = Off        
; Sleep Time                = NA         
; Tx Exit State             = STBY       
...
; Tx Packet Number          = 1          
; Tx Packet Gap             = 32         
; Packet Type               = Variable Le
; Node-Length Position      = First Node,
; Payload Bit Order         = Start from 
; Preamble Tx Size          = 8          
; Preamble Value            = 170        
; Preamble Unit             = 8-bit      
; Sync Size                 = 2-byte     
...
;--------------------------------------- 
;  The following are the Register content
;--------------------------------------- 
*/
