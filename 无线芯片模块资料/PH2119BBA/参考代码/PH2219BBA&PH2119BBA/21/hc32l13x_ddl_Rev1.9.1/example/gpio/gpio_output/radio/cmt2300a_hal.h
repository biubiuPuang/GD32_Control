...
//设置为输入
#define CMT2300A_SetGpio1In()            set_gpio1()
#define CMT2300A_SetGpio2In()            set_gpio2()
#define CMT2300A_SetGpio3In()            set_gpio3()
//获取端口状态
#define CMT2300A_ReadGpio1()             Gpio_GetInputIO(GpioPortB,GpioPin5)
#define CMT2300A_ReadGpio2()             Gpio_GetInputIO(GpioPortB,GpioPin6)
#define CMT2300A_ReadGpio3()             Gpio_GetInputIO(GpioPortB,GpioPin7)
#define CMT2300A_DelayMs(ms)             delay1ms(ms)
#define CMT2300A_DelayUs(us)             delay1us(us)
#define CMT2300A_GetTickCount()          g_nSysTickCount
